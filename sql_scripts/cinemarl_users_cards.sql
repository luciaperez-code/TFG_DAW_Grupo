...
CREATE TABLE `users_cards` (
  ...
  KEY `idCard` (`idCard`),
  CONSTRAINT `users_cards_ibfk_1` FOREIGN KEY (`idUser`) REFERENCES `users` (`idUser`),
  CONSTRAINT `users_cards_ibfk_2` FOREIGN KEY (`idCard`) REFERENCES `cards` (`idCard`)
...
INSERT INTO `users_cards` VALUES (3,1);

...
CREATE TABLE `films` (
  ...
  `comingsoon` tinyint(1) DEFAULT NULL,
...
INSERT INTO `films` VALUES (1,'El Rey León',1994,NULL,'1994-01-01','100min','Cartoon','Rob Minkoff, Roger Allers','Walt Disney','Simba, Mufasa, Nala, Scar, Zazú','Ambientada en la sabana africana donde ha nacido el futuro rey. Simba idolatra a su padre, el rey Mufasa, y se toma muy en serio su propio destino real. Pero en el reino no todos celebran la llegada del nuevo cachorro. Scar, el hermano de Mufasa y antiguo heredero al trono, tiene sus propios planes. La batalla por Pride Rock está asolada por la traición, la tragedia y el drama, y termina con el exilio de Simba. Con la ayuda de un curioso par de nuevos amigos, Simba tendrá que aprender a madurar y a recuperar lo que le pertenece por derecho.','Español','Estados Unidos','',4.55,0,NULL);
